...
func (onc OnNotCompleted) IsZero() bool {
	return onc.Wait <= 0
}
...
type KafkaSinkDefinition struct {
	...
	OnNotCompleted            OnNotCompleted                        `yaml:"on-not-completed,omitempty"  mapstructure:"on-not-completed,omitempty"  json:"on-not-completed,omitempty"`
...
func (def *KafkaSinkDefinition) WaitConfigOnNotCompleted() OnNotCompleted {
