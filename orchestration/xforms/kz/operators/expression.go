...
import (
	...
	commons2 "github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-chorus/orchestration/xforms/kz/commons"
...
func (c expressionImpl) Eval(value []byte, vars map[string]interface{}) (interface{}, error) {
	...
	mapOfVars := commons2.GetFuncMap(vars)
	for _, v := range c.Vars {
		...
		default:
			expressionVariable := commons2.NewExpressionVariable(varValue, dataType)
