...
require (
	...
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-common v0.1.75
	...
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-kafka-common v0.2.81
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-mongo-common v0.0.29
